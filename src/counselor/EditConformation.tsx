...
const EditConformation = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await axios.put(
                `http://localhost:3000/college/inquiry/${id}`,
                formData,
                {
                    headers: {
            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div className="flex items-center border rounded-lg p-3 shadow-sm">
                            ...
                            <input name="dateOfBirth" value={new Date(formData.dateOfBirth).toLocaleDateString()} onChange={handleChange} className="w-full outline-none text-sm" placeholder="Date Of Birth" />
                        </div>        
                        <div className="flex items-center border rounded-lg p-3 shadow-sm">
                            <Phone className="text-[#63589F] mr-3" />
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <input name="priority_one" value={formData.priority_one.branchName} onChange={handleChange} className="border p-2 rounded-lg shadow-sm outline-none text-sm" placeholder="Priority One" />
                        <input name="priority_two" value={formData.priority_two.branchName} onChange={handleChange} className="border p-2 rounded-lg shadow-sm outline-none text-sm" placeholder="Priority Two" />
                        <input name="priority_three" value={formData.priority_three.branchName} onChange={handleChange} className="border p-2 rounded-lg shadow-sm outline-none text-sm" placeholder="Priority Three" />


                        {/* Dropdown: Faculty */}
                        <div className="flex items-center border rounded-lg p-3 shadow-sm">
                            <PenTool className="text-[#63589F] mr-3" />
                            <input name="formFillBy" value={formData.formFillBy.facultyName} onChange={handleChange} className="w-full outline-none text-sm" placeholder="Reference Name" />
                        </div>
                ...
                <div className="flex justify-end pt-4">
                    <button type="submit" className="bg-[#63589F] hover:bg-[#51438f] text-white px-6 py-2 rounded-lg font-medium">
                        Update Inquiry
                    </button>
                </div>
            </form>
...
export default EditConformation;

import { HelpCircle, Users2, Speech, Link } from 'lucide-react';

const CollegeDashboard = () => {
  const stats = [
    { icon: HelpCircle, color: 'from-blue-500 to-blue-400', title: 'Inquiries', value: 5 },
    { icon: Users2, color: 'from-green-500 to-green-400', title: 'Faculty', value: 12 },
    { icon: Speech, color: 'from-purple-500 to-purple-400', title: 'Counselors', value: 48 },
    { icon: Link, color: 'from-orange-500 to-orange-400', title: 'Branches', value: 25 },
  ];
